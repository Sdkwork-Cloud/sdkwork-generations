...
This directory is the local SDKWork component contract for `sdkwork-generations-app-sdk`.

- Component root: `sdkwork-generations/sdks/sdkwork-generations-app-sdk`
