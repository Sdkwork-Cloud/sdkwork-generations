...
class GenerationsTimelineApi {
    ...
    async list(generationId, params) {
        ...
        return this.client.get(appendQueryString(appApiPath(`/generations/${serializePathParameter(generationId, { name: 'generationId', style: 'simple', explode: false })}/timeline`), query));
    }
}
class GenerationsResultsApi {
    constructor(client) {
        this.client = client;
    }
    async list(generationId, params) {
        ...
        return this.client.get(appendQueryString(appApiPath(`/generations/${serializePathParameter(generationId, { name: 'generationId', style: 'simple', explode: false })}/results`), query));
    }
    async saveToAssets(generationId, resultId, body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params?.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/generations/${serializePathParameter(generationId, { name: 'generationId', style: 'simple', explode: false })}/results/${serializePathParameter(resultId, { name: 'resultId', style: 'simple', explode: false })}/save_to_assets`), body, undefined, requestHeaders, 'application/json');
    }
}
class GenerationsVoiceApi {
    constructor(client) {
        this.client = client;
    }
    async speech(body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params?.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/generations/voice/speech`), body, undefined, requestHeaders, 'application/json');
    }
    async transcription(body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params?.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/generations/voice/transcription`), body, undefined, requestHeaders, 'application/json');
    }
    async translation(body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params?.idempotencyKey, style: 'simple', explode: false },
        }, {});
...
class GenerationsMusicApi {
    ...
    async textToMusic(body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params?.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/generations/music/text_to_music`), body, undefined, requestHeaders, 'application/json');
    }
    async lyricsToMusic(body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params?.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/generations/music/lyrics_to_music`), body, undefined, requestHeaders, 'application/json');
    }
}
class GenerationsVideosApi {
    constructor(client) {
        this.client = client;
    }
    async textToVideo(body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params?.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/generations/videos/text_to_video`), body, undefined, requestHeaders, 'application/json');
    }
    async imageToVideo(body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params?.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/generations/videos/image_to_video`), body, undefined, requestHeaders, 'application/json');
    }
    async videoExtend(body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params?.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/generations/videos/video_extend`), body, undefined, requestHeaders, 'application/json');
    }
}
class GenerationsImagesApi {
    constructor(client) {
        this.client = client;
    }
    async textToImage(body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params?.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/generations/images/text_to_image`), body, undefined, requestHeaders, 'application/json');
    }
    async imageEdit(body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params?.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/generations/images/image_edit`), body, undefined, requestHeaders, 'application/json');
    }
}
class GenerationsApi {
    ...
    async list(params) {
        ...
        return this.client.get(appendQueryString(appApiPath(`/generations`), query));
    }
    async get(generationId) {
        return this.client.get(appApiPath(`/generations/${serializePathParameter(generationId, { name: 'generationId', style: 'simple', explode: false })}`));
    }
    async cancel(generationId, body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params?.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/generations/${serializePathParameter(generationId, { name: 'generationId', style: 'simple', explode: false })}/cancel`), body, undefined, requestHeaders, 'application/json');
    }
    async retry(generationId, body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params?.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/generations/${serializePathParameter(generationId, { name: 'generationId', style: 'simple', explode: false })}/retry`), body, undefined, requestHeaders, 'application/json');
    }
    async favorite(generationId, body) {
        return this.client.post(appApiPath(`/generations/${serializePathParameter(generationId, { name: 'generationId', style: 'simple', explode: false })}/favorite`), body, undefined, undefined, 'application/json');
    }
}
function createGenerationsApi(client) {
...
export { BaseApi, GenerationsApi, HttpClient, SdkworkAppClient, appApiPath, createClient, createGenerationsApi, createHttpClient };
