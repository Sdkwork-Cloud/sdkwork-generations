...
export class GenerationsBackendGenerationSourceEventsApi {
  private client: HttpClient;
...
export class GenerationsBackendGenerationDispatchJobsApi {
  private client: HttpClient;
...
export function createGenerationsBackendApi(client: HttpClient): GenerationsBackendApi {
