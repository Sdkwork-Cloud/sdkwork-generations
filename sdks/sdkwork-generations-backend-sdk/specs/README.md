...
This directory is the local SDKWork component contract for `sdkwork-generations-backend-sdk`.

- Component root: `sdkwork-generations/sdks/sdkwork-generations-backend-sdk`
