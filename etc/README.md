# sdkwork-generations Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-generations` |
| `runtimeCode` | `generations` |
| Config root | `/etc/sdkwork/generations/` |
| Runtime TOML | `/etc/sdkwork/generations/config.toml` |
| Secrets | `/etc/sdkwork/generations/secrets/` |
| Override | `SDKWORK_GENERATIONS_CONFIG_FILE` |
