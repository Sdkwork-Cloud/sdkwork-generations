...
const baselinePath = path.join(
  root,
  'database/ddl/baseline/postgres/0001_generations_legacy_baseline.sql',
);
...
const prefixRegistry = {
  ...
  prefixes: [
    { prefix: 'generation_', owner: 'generations-platform', domain: 'generations' },
  ],
};
...
process.stdout.write(
  `materialized ${tableNames.length} tables into generations database contract\n`,
);
